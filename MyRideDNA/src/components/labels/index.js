...
export const DefaultText = ({ fontFamily, numberOfLines, style, ...otherProps }) => <Text numberOfLines={numberOfLines} style={[styles.defaultText, style, fontFamily ? { fontFamily } : null]}>{otherProps.children || null}</Text>
