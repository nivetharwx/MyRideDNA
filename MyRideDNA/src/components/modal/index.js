...
import { PageKeys, heightPercentageToDP, widthPercentageToDP, IS_ANDROID, APP_COMMON_STYLES, CUSTOM_FONTS, WindowDimensions } from '../../constants';
    ...
    return (
        <SafeAreaView>
            <Modal
                ...
                <View style={{ height: heightPercentageToDP(100), width: widthPercentageToDP(100), backgroundColor: 'rgba(0,0,0,0.7)' }}>
