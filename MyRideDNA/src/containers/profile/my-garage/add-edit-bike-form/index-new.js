                    ...
                    <ScrollView keyboardShouldPersistTaps='always'>
                        ...
                        <View style={{ marginLeft: widthPercentageToDP(12), marginTop: heightPercentageToDP(3) }}>
                            ...
                            <LabeledInputPlaceholder
                                ...
                                onChange={this.onChangeStreetAddress} label='MAKE' labelStyle={styles.labelStyle}
                            ...
                            <LabeledInputPlaceholder
                                ...
                                onChange={this.onChangeCity} label='MODEL' labelStyle={styles.labelStyle}
                            ...
                            <LabeledInputPlaceholder
                                ...
                                onChange={this.onChangeState} label='YEAR' labelStyle={styles.labelStyle}
                            ...
                            <LabeledInputPlaceholder
                                ...
                                onChange={this.onChangeZipCode} label='MILAGE' labelStyle={styles.labelStyle}
                            ...
                            <LabeledInputPlaceholder
                                ...
                                onChange={this.onChangePhone} label='NOTES' labelStyle={styles.labelStyle}
