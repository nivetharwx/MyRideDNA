                        ...
                        item.isDefault
                            ? <View style={styles.contentOvrImg}>
                                ...
                                <Item style={styles.txtContainer}>
                                    ...
                                    <Text style={{ color: APP_COMMON_STYLES.infoColor }}>{item.notes + ''.length > 30 ? item.notes + ''.substring(0, 27) + '...' : item.notes}</Text>
                                </Item>
                            </View>
                            : <View style={styles.contentOvrImg}>
                                <Item style={[styles.txtContainer, { marginLeft: styles.txtContainer.marginLeft + styles.activeIndicator.width }]}>
                                    <Text style={styles.bikeName}>{item.name}</Text>
                                    <Text style={{ color: '#D9D9D9' }}>{item.notes + ''.length > 30 ? item.notes + ''.substring(0, 27) + '...' : item.notes}</Text>
                                </Item>
                            </View>
                    }
                </ImageBackground>
