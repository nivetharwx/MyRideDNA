...
import { View, FlatList, ScrollView, StatusBar, Keyboard, Animated, TextInput, Text } from 'react-native';
...
import { addMembers, getAllGroupMembers } from '../../../api';
...
class Group extends Component {
    ...
    render() {
        const { kbdBtmOffset, isActiveSearch, selectedFriendList, searchFriendList, isVisibleOptionsModal, isVisibleSearchModal } = this.state;
